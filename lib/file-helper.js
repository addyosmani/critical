...
/**
 * Returns a promise to a local file (variable string version)
 * @param {string} css
 * @returns {Promise}
 */
function assertLocalString(css, ext) {
	const filepath = tempy.file({extension: ext});
	gc.addFile(filepath);
	fs.outputFile(filepath, css);
	return filepath;
}
...
exports.assertLocalString = assertLocalString;
